...
$user = /*isset($_GET['blog']) ? $_GET['blog'] : */'officenewsatiewl';

$request = "SELECT * FROM tumblr_".$user." ORDER BY timestamp DESC LIMIT 10;";
$result = mysql_query($request) or die('<p>'.mysql_error().'</p>');
