<div class="col-sm-10">
     ...
     <p class="visible-xs"><a href="info-waisthip" class="info-trigger" ><i class="fa fa-arrow-down"></i> See instructions and description below.</a></p>
</div>
...
<div class="col-sm-3  col-sm-push-6 calc_result_wrapper">
     ...
     <p style="margin-left:0; margin-top:1rem; display:none;" id="warning">If your waist to hip ratio is greater than 0.80 for a woman or greater than 0.95 for a man, you should lose weight to lower your risk of heart disease, diabetes, and cancer.</p>
</div>

<div class="clear tall_20 visible_sm"></div>

<div class="col-sm-6 col-sm-pull-6" id="info-waisthip">
