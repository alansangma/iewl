<div class="col-sm-10 ">
     ...
     <p class="visible-xs"><a href="info-bodyfat" class="info-trigger"><i class="fa fa-arrow-down"></i> See description below.</a></p>
</div>
...
<div class="col-sm-6 col-sm-pull-6" id="info-bodyfat">
